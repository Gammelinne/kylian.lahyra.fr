      ...
      <TabPanels>
        ...
        >
          <Card>
            <template #content>
              <p
                v-for="desc in project.description.split('-')"
                :key="desc"
                class="my-2"
              >
                {{ desc }}
            ...
            <template #footer>
              ...
              <Button
                ...
                @click="dialogVisibility[project.value] = true"
              />
            </template>
          </Card>
          <Dialog
            v-model:visible="dialogVisibility[project.value]"
            header="Routes"
            @hide="dialogVisibility[project.value] = false"
          >
            <DataTable
