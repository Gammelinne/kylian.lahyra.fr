      ...
      <div v-if="experiences.length > 0">
        <Timeline :value="experiences" align="alternate" class="my-10">
          <template #marker="slotProps">
            <Button disabled class="p-button-rounded" :icon="slotProps.item.isComputerScience
              ? 'pi pi-desktop'
              : 'pi pi-briefcase'
          ...
          <template #content="slotProps">
            <Card class="mx-8">
              ...
              <template #content>
                <img :src="slotProps.item.logo" alt="logo" :class="'w-20 mx-3' +
                ...
                ">
                  <p v-for="description in slotProps.item.description.split(
                    ' -',
                  )" :key="description" class="my-5" style="text-align: justify">
                    - {{ description }}
                  </p>
                </div>
              </template>
    ...
    <div v-else class="text-center">
      ...
      <div class="flex flex-col space-y-5">
        <Card v-for="experience in experiences" :key="experience.title" class="mx-12 my-5">
          ...
          <template #content>
            <div class="space-y-2">
              <Button disabled class="p-button-rounded" :icon="experience.isComputerScience
                ? 'pi pi-desktop'
                : 'pi pi-briefcase'
              ...
              ">
                <p v-for="description in experience.description.split(' -')" :key="description" class="my-5"
