export default defineI18nConfig(() => ({
  ...
  Education: {
    ...
    Three: {
      ...
      Description: "Group work,Mathematics,Computer science,Physics,English",
      Location: "4 place boston - 14200 Hérouville-Saint-Clair",
    },
    Two: {
      Title:
    ...
    One: {
      ...
      Route: {
        ...
        3: {
          ...
          Description:
            "Retrieves information about Laravel WebSockets applications.",
        },
        4: {
          Method: "HEAD",
          Endpoint: "/laravel-websockets/apps",
        ...
        6: {
          ...
          Description:
            "Retrieves statistics for a specific Laravel WebSockets application.",
        },
        7: {
          Method: "HEAD",
          Endpoint: "/laravel-websockets/api/{appId}/statistics",
          Description:
            "Retrieves headers of statistics for a specific Laravel WebSockets application.",
        },
        8: {
          Method: "POST",
  ...
  Hobbies: {
    Music: {
      Title: "Music",
      Artist: "My favorite artists",
      Playlist: "My playlists",
      Question: "What are the French artists in the list?",
      Submit: "Submit",
      Success: "Congratulations!",
      Error: "Try again",
      SucessMessage: "You have successfully completed the quiz!",
      ErrorMessage: "You have not completed the quiz correctly! (3 answers)",
    },
    Games: {
      Title: "Jeux",
    },
